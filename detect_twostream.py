...
def detect(opt):
    ...
    save_img = not opt.nosave and not source1.endswith(
    ...
    for (path, img, im0s, vid_cap), (path_, img2, im0s_, vid_cap_) in zip(dataset, dataset2):
        ...
        pred, _ = model(img, img2, augment=opt.augment)[0]
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or opt.save_crop or view_img:  # Add bbox to image
                        ...
                        plot_one_box(xyxy, im0_, label=label, color=colors(
                            c, True), line_thickness=opt.line_thickness)
                        if opt.save_crop:
                            save_one_box(
            ...
            if save_img:
                if dataset.mode == 'image':
                    save_path_rgb = save_path.split(
                        '.')[0] + '_rgb.' + save_path.split('.')[1]
                    save_path_ir = save_path.split(
                        '.')[0] + '_ir.' + save_path.split('.')[1]
                    print(save_path_rgb)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='runs/train/exp143/weights/best.pt', help='model.pt path(s)')
    # file/folder, 0 for webcam
    parser.add_argument('--source1', type=str,
                        default='/home/disk0/zyq/datasets/M3FD/RGBimages/val/01292.png', help='source')  # /home/disk0/zyq/datasets/LLVIP/RGBimages/train/   MSRS/RGBimages/train/3.png
    # M3FD 00349 val/00569 train/00638 val/00716 00883 val/01292
    # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str,
                        default='/home/disk0/zyq/datasets/M3FD/IRimages/val/01292.png', help='source')  # /home/disk0/zyq/datasets/LLVIP/IRimages/train/
